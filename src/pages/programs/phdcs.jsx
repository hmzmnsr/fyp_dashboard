...
import PHDCSPopup from "../../components/popups/phdcs.popup";
import UpdateCoursePopup from "../../components/popups/phdcs.update.popup";
import PHDCSTable from "../../components/tables/phdcs.table";
import { fetchAllPHDCS, deletePHDCS } from "../../redux/actions/phdcs.action";
...
const PHDCS = () => {
    ...
    const handleDeleteRoadmap = async (roadmapId) => {
        try {
            const response = await dispatch(deletePHDCS(roadmapId));
            if (response.type === 'phdcs/delete/fulfilled') {
                setRoadmap(prevRoadmap => {
