...
import MSCSPopup from "../../components/popups/mscs.popup";
import UpdateCoursePopup from "../../components/popups/mscs.update.popup";
import MSCSTable from "../../components/tables/mscs.table";
import { fetchAllMSCS, deleteMSCS } from "../../redux/actions/mscs.action";
...
const MSCS = () => {
    ...
    const handleDeleteRoadmap = async (roadmapId) => {
        try {
            const response = await dispatch(deleteMSCS(roadmapId));
            if (response.type === 'mscs/delete/fulfilled') {
                setRoadmap(prevRoadmap => {
