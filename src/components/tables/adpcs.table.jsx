...
import { deleteCourseInADPCS } from "../../redux/actions/adpcs.action";

const ADPCSTable = ({ semester, roadmap, onEdit, setRoadmap, termYear }) => {
    ...
    const handleDeleteCourse = async (course) => {
        ...
        try {
            const response = await dispatch(deleteCourseInADPCS({ roadmapId, courseId }));

            if (response.type === 'adpcs/deleteCourse/fulfilled') {
