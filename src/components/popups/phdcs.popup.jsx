...
import { createPHDCS } from '../../redux/actions/phdcs.action';

const PHDCSPopup = ({ setShowPopup, addRoadmapEntry }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await dispatch(createPHDCS(newCourseData));
