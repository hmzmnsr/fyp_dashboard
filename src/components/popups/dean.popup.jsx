...
const AddDeanHODPopup = ({ onClose, onAdd }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        onAdd({ name, position, qualification, image });
        onClose();
    };
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center'>
            <div className='bg-white px-20 py-10 rounded-lg w-3/6'>
                <h2 className='text-xl font-bold mb-4'>Add Dean or HOD</h2>
...
export default AddDeanHODPopup;
